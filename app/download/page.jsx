...
function page() {
    const [releaseDate, setReleaseDate] = useState("2024-9-10")
        ...
        <div>
            ...
            <div style={{ marginTop: "100px" }} className='d-flex justify-content-center'>
                <div className='custom-card outline-success p-4'>
                    ...
                    <p className='text-success'>Realese Date: {releaseDate}</p>
                    ...
                    {isDownloadEnabled ? (
                        ...
                        <Button className='bg-dark button-100' variant="outline-success">
                            <a className='text-success text-decoration-none' href="/download"><DownloadIcon /> Download</a>
                        </Button>
                    )}
                </div>
            </div>
